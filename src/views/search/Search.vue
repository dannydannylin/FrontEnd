                ...
                <div class="twelve wide column">
                    ...
                    <div class="ui top attached segment">
                        <div class="ui middle aligned two column stackable grid">
                            <div class="column">
                                <h3 v-if="success" class="ui blue header" style="font-size: x-large">
                                    搜尋結果
                                </h3>
                                <h3 v-else v-text="'找不到 ' + $route.query.searchText + ' 的相關資料'" class="ui blue header" style="font-size: x-large">
                                    錯誤
                                </h3>
                            </div>
...
export default {
    ...
    created() {
        this.pageCount = 0 ;
        const _this = this  ;
        axios.post(axios.defaults.baseURL + "/controller/search/0",
        ...
        axios.post(axios.defaults.baseURL + "/controller/searchTotalPage",
            { searchText : this.$route.query.searchText })
            .then(function (resp) {
