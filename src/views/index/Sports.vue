                        ...
                        <div class="ui padded vertical segment">
                            <div class="ui mobile reversed stackable grid">
                                ...
                                <div class="five wide column">
                                    <!--文章圖片-->
                                    <img src="../../../public/sports.jpg" class="ui rounded image" alt="" width = "150" height = "150" style="margin-left: auto;margin-right: auto">
                                </div>
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        ...
        nextPage() {
            ...
            const _this = this  ;
            axios.get(axios.defaults.baseURL + "/controller/sports/" + this.pageCount)
                .then(function (resp) {
    ...
    created() {
        this.pageCount = 0 ;
        const _this = this  ;
        axios.get(axios.defaults.baseURL + "/controller/sports/0")
            .then(function (resp) {
                _this.articles = resp.data.content ;
            });
        axios.get(axios.defaults.baseURL + "/controller/totalPage/1")
            .then(function (resp) {
