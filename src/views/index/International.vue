...
export default {
    ...
    methods: {
        ...
        nextPage() {
            ...
            const _this = this  ;
            axios.get(axios.defaults.baseURL + "/controller/international/" + this.pageCount)
                .then(function (resp) {
    ...
    created() {
        this.pageCount = 0 ;
        const _this = this  ;
        axios.get(axios.defaults.baseURL + "/controller/international/0")
            .then(function (resp) {
                _this.articles = resp.data.content ;
            });
        axios.get(axios.defaults.baseURL + "/controller/totalPage/3")
            .then(function (resp) {
