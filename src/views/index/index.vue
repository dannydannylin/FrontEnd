    ...
    export default {
        ...
        methods: {
            ...
            nextPage() {
                ...
                const _this = this  ;
                axios.get("http://localhost:8081/controller/index/" + this.pageCount)
                    .then(function (resp) {
        ...
        created() {
            this.pageCount = 0 ;
            const _this = this  ;
            axios.get("http://localhost:8081/controller/index/0")
                .then(function (resp) {
                    _this.articles = resp.data.content ;
            });
            axios.get("http://localhost:8081/controller/totalPage/0")
                .then(function (resp) {
