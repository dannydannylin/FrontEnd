...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            deleteArticle(id) {
                const _this = this ;
                axios.delete(axios.defaults.baseURL + "/controller/article/" + id,
                    {
                        headers: {
                            token: store.state.token
                        }
            ...
            sendComment() {
                ...
                axios.post(axios.defaults.baseURL + "/controller/comments/", this.comment)
                    .then(function (reps){
                        if ( reps.data ) {
                            // 再發送一次請求
                            // 達到刷新頁面的效果
                            axios.get(axios.defaults.baseURL + "/controller/comments/" + articleId)
                                .then(function (reps){
            ...
            deleteComment(id) {
                ...
                const _this = this ;
                const articleId = this.$route.params.id ;
                axios.delete(axios.defaults.baseURL + "/controller/comments/" + id)
                    .then(function (reps){
                        if ( reps.data ) {
                            // 再發送一次請求
                            // 達到刷新頁面的效果
        ...
        created() {
            ...
            axios.get(axios.defaults.baseURL + "/controller/article/" + articleId)
                ...
                if ( reps.data !== null ) {
                    ...
                    // 更新點閱次數
                    axios.get(axios.defaults.baseURL + "/controller/article/addViews/" + articleId)
                        .then(function (reps){
