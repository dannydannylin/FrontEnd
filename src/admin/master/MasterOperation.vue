...
export default {
    ...
    methods: {
        updateData() {
            const _this = this ;
            axios.get("http://localhost:8081/controller/admin/master/users",
                {
                    headers: {
        ...
        blockPost(block, id, account) {
            ...
            if ( block ) {
                ...
                if ( confirm( msg ) ){
                    axios.put("http://localhost:8081/controller/admin/master/userPost/" + id
                        ,{},
                        {
                            headers: {
                                token: store.state.token
                ...
                if ( confirm( msg ) ){
                    axios.delete("http://localhost:8081/controller/admin/master/userPost/" + id,
                        {
                            headers: {
                                token: store.state.token
                            }
        ...
        blockComment(block, id, account) {
            ...
            if ( block ) {
                ...
                if ( confirm( msg ) ){
                    axios.put("http://localhost:8081/controller/admin/master/userComment/" + id,{},
                        {
                            headers: {
                                token: store.state.token
                            }
                ...
                if ( confirm( msg ) ){
                    axios.delete("http://localhost:8081/controller/admin/master/userComment/" + id,
                        {
                            headers: {
                                token: store.state.token
                            }
